...
from productised_code_v4.company_name.productised_code_v4.tasks.table_insertion_based_on_excel_submitted_in_a_form import main_code_table_insertion_based_on_excel_submitted_in_a_form
...
with DAG(
    ...
    table_insertion_based_on_excel_submitted_in_a_form = PythonOperator(
        task_id='table_insertion_based_on_excel_submitted_in_a_form',
        python_callable=task_wrapper('table_insertion_based_on_excel_submitted_in_a_form', main_code_table_insertion_based_on_excel_submitted_in_a_form)
    )
    ...
    table_insertion_based_on_excel_submitted_in_a_form,
    no_op
]
